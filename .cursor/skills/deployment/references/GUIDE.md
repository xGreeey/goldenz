...
This guide provides comprehensive documentation for the **deployment** skill in the custom-plugin-nextjs plugin.
...
```bash
# Invoke the skill
claude "deployment - [your task description]"

# Example
claude "deployment - analyze the current implementation"
```
...
def implement_deployment(input_data):
    """
