...
This guide provides comprehensive documentation for the **api-routes** skill in the custom-plugin-nextjs plugin.
...
```bash
# Invoke the skill
claude "api-routes - [your task description]"

# Example
claude "api-routes - analyze the current implementation"
```
...
def implement_api_routes(input_data):
    """
    Implement api-routes functionality.
