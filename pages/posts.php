...
<div class="container-fluid hrdash">
    ...
    <div class="hrdash-welcome">
        <div class="hrdash-welcome__left">
            <h2 class="hrdash-welcome__title">Posts & Locations</h2>
            <p class="hrdash-welcome__subtitle">Manage job positions, assignments, and locations</p>
        </div>
...
<script>
// Update time display every minute for posts page
(function() {
    function updateTime() {
