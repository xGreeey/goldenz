...
.handbook-container .page-header {
    display: flex;
...
.handbook-container .page-header .page-title h1 {
    margin: 0 0 0.5rem 0;
    font-size: 1.75rem;
    font-weight: 700;
    color: #1e293b;
...
.handbook-container .page-header .page-title .text-muted {
    margin: 0;
    color: #64748b;
    font-size: 0.875rem;
}

.handbook-container .page-header .page-actions {
    display: flex;
    gap: 0.75rem;
    align-items: center;
}
