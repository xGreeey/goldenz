...
<div class="container-fluid hrdash">
    ...
    <div class="hrdash-welcome">
        <div class="hrdash-welcome__left">
            ...
            <p class="hrdash-welcome__subtitle">Manage employee assignments to specific posts and locations</p>
        </div>
...
<script>
// Update time display every minute for post assignments page
(function() {
    function updateTime() {
