...
This guide provides comprehensive documentation for the **data-fetching** skill in the custom-plugin-nextjs plugin.
...
```bash
# Invoke the skill
claude "data-fetching - [your task description]"

# Example
claude "data-fetching - analyze the current implementation"
```
...
def implement_data_fetching(input_data):
    """
