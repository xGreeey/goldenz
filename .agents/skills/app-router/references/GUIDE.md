...
This guide provides comprehensive documentation for the **app-router** skill in the custom-plugin-nextjs plugin.
...
```bash
# Invoke the skill
claude "app-router - [your task description]"

# Example
claude "app-router - analyze the current implementation"
```
...
def implement_app_router(input_data):
    """
    Implement app-router functionality.
